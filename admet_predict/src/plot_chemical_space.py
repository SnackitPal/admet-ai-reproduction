...
predictions_df = pd.read_csv('admet_predict/data/predictions.csv')
...
plt.legend()
plt.grid(True)
plt.savefig('admet_predict/images/chemical_space_plot.png', dpi=300)

print("Chemical space plot saved to admet_predict/images/chemical_space_plot.png")
